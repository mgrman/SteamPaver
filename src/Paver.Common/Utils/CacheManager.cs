...
namespace Paver.Common.Utils
{
    ...
    public static class CacheManager
    {
        ...
        public static Task<T> LoadFromCacheAsync<T>(string instanceID)
            where T : ICacheable
        {
            return Task.Run(() => LoadFromCache<T>(instanceID));
        }
        ...
        public static Task SaveToCacheAsync<T>(this T obj)
            where T : ICacheable
        {
            return Task.Run(() => SaveToCache(obj));
        }
        ...
        public static Task RemoveFromCacheAsync<T>(this T obj)
            where T : ICacheable
        {
            return Task.Run(()=>RemoveFromCache(obj));
        }
